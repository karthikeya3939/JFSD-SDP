...
<form:form method="post" action="insertfaculty" modelAttribute="faculty">
...
<td>
<form:input path="name" required="required" placeholder="Enter full name" ></form:input>
</td>
</tr>
...
<tr>
    ...
    <tr><td></td></tr>
        ...
        <tr>
            ...
            <td><form:input path="college" required="required"/></td>
            </tr>
...
<td><form:input path="email" required="required" placeholder="Enter e-mail id" /></td>
</tr>
